document.addEventListener('DOMContentLoaded', () => {
    ...
    Particle.prototype = {
        update:function() {
            ...
            this.r =  Math.atan2(dy, dx) + HALF_PI2;
    ...
    Loader.prototype = {
        ...
        draw:function() {
            ...
            ctx.beginPath();
            ctx.arc(this.x, this.y, this.r, -HALF_PI2, TWO_PI2 * this._progress - HALF_PI2);
    ...
    Exploader.prototype = {
        ...
        draw:function() {
            ctx.fillStyle = 'transparent';
            ctx.beginPath();
            ctx.arc(this.x, this.y, this.startRadius * (1 - this.progress), 0, TWO_PI2);
            ctx.fill();
        }
    };
